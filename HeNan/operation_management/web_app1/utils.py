...
COLUMN_MAPPING = {
    ...
    '集数': 'episode_count', '单集时长': 'single_episode_duration', '单集时长（分）': 'single_episode_duration', '单集时长(分)': 'single_episode_duration',
    '总时长': 'total_duration', '总时长（分）': 'total_duration', '总时长(分)': 'total_duration',
