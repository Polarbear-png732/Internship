...
CUSTOMER_CONFIGS = {
    ...
    'shandong_mobile': {
        ...
        'drama_columns': [
            {'col': '剧头id', 'field': 'drama_id'},
            {'col': '剧集名称', 'field': 'drama_name'},
            {'col': '导演', 'source': 'director', 'separator': '|'},
            {'col': '清晰度', 'value': 1},
    ...
    'jiangsu_newmedia': {
        ...
        'drama_columns': [
            ...
            {'col': 'volumnCount', 'source': 'episode_count'},
            {'col': 'description', 'source': 'synopsis'},
            {'col': 'seriesFlag', 'value': 1},
            {'col': 'sortName', 'type': 'pinyin_abbr'},
            {'col': 'programType', 'value': '维高绘本'},
            {'col': 'releaseYear', 'source': 'production_year'},
            {'col': 'language', 'source': 'language'},
            {'col': 'rating', 'source': 'rating'},
            {'col': 'originalCountry', 'source': 'country'},
            {'col': 'pgmCategory', 'value': '少儿'},
            {'col': 'pgmSedClass', 'value': '启蒙,教育,益智'},
            {'col': 'director', 'source': 'director'},
            {'col': 'actorDisplay', 'source': 'cast_members'},
        ],
    ...
    'jiangxi_mobile': {
        ...
        'drama_columns': [
            ...
            {'col': '上映年份', 'source': 'production_year'},
            {'col': '总集数', 'source': 'episode_count'},
            {'col': '首播日期', 'source': 'premiere_date', 'format': 'date_compact'},
            {'col': '标签', 'source': 'keywords', 'default': ''},
            {'col': '国家地区', 'source': 'country', 'default': '中国'},
            {'col': '评分', 'source': 'rating'},
            {'col': '时长', 'source': 'total_duration', 'format': 'int'},
            {'col': '推荐语', 'source': 'recommendation', 'default': ''},
            ...
            {'col': '版权平台', 'value': 'TV'},
            {'col': '版权开始时间', 'source': 'copyright_start_date', 'format': 'datetime_compact'},
            {'col': '版权结束时间', 'source': 'copyright_end_date', 'format': 'datetime_compact'},
            {'col': '版权区域', 'value': '江西'},
        ],
